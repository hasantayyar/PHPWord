...
class PHPWord_Shared_String
{
     ...
     * _xHHHH_ where H represents a hexadecimal character in the character's
     * value...
     * So you could end up with something like _x0008_ in a string (either in a
     * cell value (<v>)
     ...
     * length)
     * Writes the string using uncompressed notation, no rich text, no Asian
     * phonetics
     * If mbstring extension is not available, ASCII is assumed, and compressed
     * notation is used
     * although this will give wrong results for non-ASCII strings
     * see OpenOffice.org's Documentation of the Microsoft Excel File Format,
     * sect. 2.5.3
     *
     * @param string $value
    ...
    /**
     * Converts a UTF-8 string into BIFF8 Unicode string data (16-bit string
     * length)
     * Writes the string using uncompressed notation, no rich text, no Asian
     * phonetics
     * If mbstring extension is not available, ASCII is assumed, and compressed
